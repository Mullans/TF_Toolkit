...
def tf_transform(images, transforms, interpolation='NEAREST', fill_mode='REFLECT', output_shape=None, name=None):
...
def tb2df(path):
    """Convert a tensorboard log file to a pandas DataFrame
